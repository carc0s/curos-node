// DAOuser.js
const fs = require("fs");
const usuarios = require('../modelos/user');
const bcrypt = require('bcrypt');
const mongoose = require('mongoose-pagination');
const path = require("path");
const validador = require('../helppers/validator');
...
// Validar datos
  ...
  try {
    ...
    let usucreado= nuevoUsuario.toObject();
    delete usucreado.password;
    delete usucreado.rol;
    return res.status(200).json({
      status: "success",
...
const buscarImagen = (req, res) => {
  ...
  console.log(archivo);
  let rutaarchivo = "./imagenes/" + archivo;
